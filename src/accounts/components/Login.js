...
class Login extends React.Component {
  ...
  async handleRegisterClick() {
    ...
    if (this.state.username === "") {
      ...
      this.state.newAccountConfirmPassword !== this.state.newAccountPassword
    ) {
      this.setState({
  ...
  infoText = (success) => {
    ...
    if (success === false) {
      return (
        <p style={{ color: "#F80505" }}>Ops ! Error: {this.state.error} </p>
      );
    }
    if (success === true) {
              ...
              {this.state.option === 1 ? (
                ...
                >
                  ...
                  {this.renderInputfield(
                    "Confirm password",
                    "●●●●●●●●●",
                    this.handleChangeNewPasswordConfirm,
                    "password",
                  ...
                  <button
                    style={style.alreadyHaveAccount}
                    onClick={() => {
                      this.setState({
                        option: 1,
                        success: "",
            ...
            <div style={styleMobile.containerStyle}>
              {this.state.option === 1 ? (
                ...
                >
                  ...
                  <button
                    style={styleMobile.dontHaveAccount}
                    onClick={() => {
                      this.setState({
                        option: 2,
                        success: "",
                ...
                >
                  ...
                  <Button
                    variant="danger"
                    style={styleMobile.registerButton}
                    onClick={this.handleRegisterClick}
                  >
                    Register
                  </Button>
