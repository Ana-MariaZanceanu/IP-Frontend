...
const AccountSettings = ({ data }) => {
  ...
  return (
    <div>
        ...
        <div className="account_settings_form">
          <Form>
            ...
            <div className="profile_element">
              ...
              <p className="profile_explanations">
                <small>
                  Communication is the key to successful relationships. So
                  please provide us a valid email so we can keep in touch
                </small>
              </p>
              <div className="account_settings_elements">
                <FormGroup>
      ...
      {isTabletOrMobile && (
        <div className="account_settings_form_phone">
          <Form>
            <div className="profile_title">
              <h2>Account Settings</h2>
            </div>
